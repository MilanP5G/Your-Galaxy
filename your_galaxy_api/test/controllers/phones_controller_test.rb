...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { cons: @phone.cons, image: @phone.image, pros: @phone.pros, title: @phone.title } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { cons: @phone.cons, image: @phone.image, pros: @phone.pros, title: @phone.title } }
